...
namespace DiscordBot
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeFormControls()
        {
            ...
            downloadThemeToolStripMenuItem.Click += (sender, e) =>
            {
        ...
        private void InitializeTheme()
        {
            ...
            themeToolStripMenuItem.Click += (sender, e) =>
            {
                themeToolStripMenuItem.DropDownItems.Clear();
                themeToolStripMenuItem.DropDownItems.Add(darkToolStripMenuItem);
                themeToolStripMenuItem.DropDownItems.Add(lightToolStripMenuItem);


                if (!Directory.Exists(@".\Data\Themes"))
                {
                    themeToolStripMenuItem.DropDownItems.Add(downloadThemeToolStripMenuItem);
                    return;
                }
                ...
                foreach (var file in Directory.GetFiles(@".\Data\Themes", "*.dbtheme", SearchOption.AllDirectories))
                {
                    ...
                    if (t == null) continue;
                    ToolStripMenuItem item = new ToolStripMenuItem(t.ThemeName);
                    item.Click += (sender2, e2) =>
                    {
                        t.SetTheme(this);
                        WriteToSettings(dataFolder + "DiscordBotSettings.data", "THEME", t.ThemeName, '=');
                    };
            ...
            else if (theme == "Dark") dark.SetTheme(this);
            else
            {
                if (!Directory.Exists(".\\Data\\Themes"))
                    dark.SetTheme(this);
                foreach (var file in Directory.GetFiles(".\\Data\\Themes"))
                {
                    ...
                    {
                        Theme.LoadFromFile(file).SetTheme(this);
                        return;
                    }
                }
            }
